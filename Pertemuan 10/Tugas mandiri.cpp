...
int main() {
    ...
    // Menyalin nilai yang lebih besar dari 10 dari array A ke array C (urutan benar)
    for (int i = 0; i < 5; i++) {
        if (A[i] > 10) {
            C[index_C] = A[i];
            index_C++;
    ...
    // Menyalin nilai yang lebih besar dari 10 dari array B ke array C (urutan benar)
    for (int i = 0; i < 4; i++) {
        if (B[i] > 10) {
            C[index_C] = B[i];
            index_C++;
